...
const mockJobs = [
  {
    ...
    type: "Full-time",
    description: "Looking for an experienced HR manager to oversee operations and talent acquisition strategies.",
    deadline: "2026-04-15",
    status: "open",
    posted: "2026-03-01"
  },
  {
    ...
    type: "Full-time",
    description: "Join our fast-paced recruitment team to source and interview top talent for tech clients.",
    deadline: "2026-03-20",
    status: "open",
    posted: "2026-02-25"
  },
  {
    ...
    type: "Contract",
    description: "Detail-oriented professional needed for managing complex payroll systems across multiple regions.",
    deadline: "2026-04-01",
    status: "open",
    posted: "2026-03-05"
  },
  {
    ...
    type: "Part-time",
    description: "Design and implement management training programs for our corporate clients.",
    deadline: "2026-02-28", // Past deadline
    status: "closed",
    posted: "2026-01-15"
  }
];
